...
class Matrixcode_Qrcode extends Matrixcode_AbstractMatrixcode
{
     ...
     * @var string
     */
    protected $_eccLevel = Matrixcode_Qrcode_Qrspecs::QR_ECC_M;
    ...
    public function setEccLevel ($level)
    {
        if ($level != '') {
            ...
            } elseif (in_array($level, Matrixcode_Qrcode_Qrspecs::$eccLevels)) {
    ...
    protected function _prepareDataMatrix ($original_data = null)
    {
        ...
        if ($total_data_bits <= $max_data_bits - 4) {
            ...
            } elseif ($total_data_bits > $max_data_bits) {
                throw new Matrixcode_Qrcode_Exception(
    ...
    /**
     * @see Matrixcode_Abstract::_checkParams()
     */
    protected function _checkParams() {}

    /**
     * @see Matrixcode_Abstract::_prepareMatrixcode()
     */
